...
CUSTOM_PACKAGES="blockd block-mount kmod-fs-ext4 kmod-fs-ntfs3 kmod-usb2 kmod-usb3 kmod-usb-storage kmod-usb-core \
    base-files busybox ca-bundle dnsmasq dropbear e2fsprogs firewall4 fstools grub2-bios-setup kmod-button-hotplug \
...
#######################################################################################################################
    ...
    ROOT_RESIZE_DEF="4096"    # OWRT default is 104 MB. 1024-2048-3072-4096 is the max if you want to use sysupgrade. Don't go above 8192.
